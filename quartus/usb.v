...
module usb(
    ...
    in_port #(.WIDTH(1)) u39 (32'h80000070, clock_main, 1'b1, clock,
            address_out, memory_drive, bus, mouse_command);
    ...
    in_port #(.WIDTH(1)) u46 (32'h800000e0, clock_main, 1'b1, clock,
            address_out, memory_drive, bus, touch_command);
