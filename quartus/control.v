...
module control(
    ...
    parameter state_blt6 =   8'h61;
	 // add new state parameter for cpfa
    ...
    parameter state_call3 =  8'h73;
	 // ret
	 parameter state_ret1 =   8'h74;
    parameter state_ret2 =   8'h75;
    ...
    always @* begin
        ...
        case (state)
            ...
            state_cpfa1: begin
                // transfer arg1 to address register
                arg3_drive = 1'b1;
                address_write = 1'b1;
            ...
            state_cpfa2: begin
                // read memory from arg1 and store it back in arg1
                memory_drive = 1'b1;
                op2_write = 1'b1;
            ...
            state_cpfa3: begin
                // transfer arg3 to address register
                arg2_drive = 1'b1;
                op1_write = 1'b1;
            ...
            state_cpfa4: begin
                // read memory [arg3] and store it in op2 
					 arg1_drive = 1'b1;
                address_write = 1'b1;
            ...
            state_cpfa5: begin
                // transfer the address of arg2 to op1 
                add_drive = 1'b1;
					 address_write = 1'b1;
            ...
            state_cpta6: begin
                // calculate arg2 + memory[arg3] and write it to the address register
                add_drive = 1'b1;
                address_write = 1'b1;
            ...
            state_cpta7: begin
                // write stored memory[arg1] into the calculated address
                arg1_drive = 1'b1;
                memory_write = 1'b1;
                next_state = state_fetch1;
            end 
